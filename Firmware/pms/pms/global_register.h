...
#define	ADDRESS_TEMP_SENS_OUTPUT	0x49
#define	ADDRESS_CURRENT_SENS_SOLAR	0x42
#define	ADDRESS_CURRENT_SENS_BUS	0x40
#define	ADDRESS_CURRENT_SENS_5V		0x41
#define	ADDRESS_CURRENT_SENS_3V3	0x43
#define	ADDRESS_QI_RECEIVER			0x25			
#define	ADDRESS_RHEOSTAT			0b0101111
...
#define CUR_MASK_REG		0x06
#define CUR_ALERT_REG		0x07
