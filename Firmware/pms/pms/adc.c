...
//	result4 = ADCA.CH3.RES;
	...
	vlaptop = result1/4096 * 108/8; //(result1 - offset1)/4096 * 108/8;
	fuse_16v = result2/4096 * 111/11; //(result2 - offset2)/4096 * 111/11;
	fuse_5v = result3/4096 * 100/40; //(result3 - offset3)/4096 * 100/40;
